                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="edit_duration" name="edit_duration" placeholder="Ex : 6 mois" value="{{ old('edit_duration') ? old('edit_duration') : $offer->duration }}" />
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="edit_remuneration" name="edit_remuneration" required="required" value="{{ old('edit_remuneration') ? old('edit_remuneration') : $offer->remuneration }}" placeholder="Ex : 10€/h" />
                                    </div>
