    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Accepter et envoyer cette candidature</h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                <a href="#" id="btn-accept-apply" type="submit" class="btn btn-success submit-btn" style="-webkit-appearance: initial;">Accepter et envoyer</a>
            </div>
        </div>
    </div>
</div>